...
if "%discipline" = "shaping" then
	{
		...
		matchre chatper.4 This logbook is tracking a work order requiring you to craft (a composite bow|a double-backed bow|a recurve bow|a forester's bow|a reflex bow|a savannah bow|a footman's bow|a horseman's bow|a battle bow|a competition bow) from any material\.
...
if "%discipline" = "remed" then
		...
		matchre chapter.4 This logbook is tracking a work order requiring you to craft (a neck potion|a back potion|an eye potion|some neck tonic|some back tonic|some eye tonic)
